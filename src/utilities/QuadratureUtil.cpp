...
void getGaussPoints1D(int ngp, vector<double>& gausspoints, vector<double>& gaussweights)
{
    ...
    switch(ngp)
    {
        ...
        case 3:  //3 Point quadrature rule
            ...
            gausspoints[1] =  0.774596669241483;  gaussweights[1] = 5.0/9.0;
            gausspoints[2] =  0.0;                gaussweights[2] = 8.0/9.0;
...
int  getGaussPoints2D(int npElem, vector<double>& gausspoints1, vector<double>& gausspoints2, vector<double>& gaussweights)
{
    int nGP;
...
int  getGaussPoints3D(int npElem, vector<double>& gausspoints1, vector<double>& gausspoints2, vector<double>& gausspoints3, vector<double>& gaussweights)
{
    int nGP;
    ...
    {
        throw runtime_error("getGaussPoints3D ... Element type not defined...");
    }
...
void getGaussPointsQuad(int ngp, vector<double>& gps1, vector<double>& gps2, vector<double>& gws)
{
    ...
    switch(ngp)
    {
        case 1:  // 1 Point quadrature rule
            ...
            gps1[0] = 0.0;                   gps2[0] = 0.0;                   gws[0] = 4.0;

            break;

         case 4: //4 Point quadrature rule

            gps1[0] = -0.577350269189626;    gps2[0] = -0.577350269189626;    gws[0] = 1.0;
            gps1[1] =  0.577350269189626;    gps2[1] = -0.577350269189626;    gws[1] = 1.0;
            gps1[2] =  0.577350269189626;    gps2[2] =  0.577350269189626;    gws[2] = 1.0;
            gps1[3] = -0.577350269189626;    gps2[3] =  0.577350269189626;    gws[3] = 1.0;

            break;

         case 9:  //9 Point quadrature rule

            gps1[0] = -0.774596669241483;    gps2[0] = -0.774596669241483;    gws[0] = 25.0/81.0;
            gps1[1] =  0.774596669241483;    gps2[1] = -0.774596669241483;    gws[1] = 25.0/81.0;
            gps1[2] =  0.774596669241483;    gps2[2] =  0.774596669241483;    gws[2] = 25.0/81.0;
            gps1[3] = -0.774596669241483;    gps2[3] =  0.774596669241483;    gws[3] = 25.0/81.0;

            gps1[4] =  0.0;                  gps2[4] = -0.774596669241483;    gws[4] = 40.0/81.0;
            gps1[5] =  0.774596669241483;    gps2[5] =  0.0;                  gws[5] = 40.0/81.0;
            gps1[6] =  0.0;                  gps2[6] =  0.774596669241483;    gws[6] = 40.0/81.0;
            gps1[7] = -0.774596669241483;    gps2[7] =  0.0;                  gws[7] = 40.0/81.0;

            gps1[8] =  0.0;                  gps2[8] =  0.0;                  gws[8] = 64.0/81.0;
...
void getGaussPointsHexa(int ngp, vector<double>& gpts1, vector<double>& gpts2, vector<double>& gpts3, vector<double>& gwts)
{
    int  nn=0;
    if(ngp == 1)        nn = 1;
    else if(ngp == 8)   nn = 2;
    ...
    vector<double>  gps1d(nn), gws1d(nn);
    getGaussPoints1D(nn, gps1d, gws1d);
    ...
    switch(ngp)
    {
        case 1:  // 1 Point quadrature rule
            ...
            gpts1[0]  = 0.0;         gpts2[0]  = 0.0;         gpts3[0]  = 0.0;         gwts[0] = 8.0;

            break;

        case 8: //8 Point quadrature rule

            gpts1[0]  = gps1d[0];    gpts2[0]  =  gps1d[0];   gpts3[0]  =  gps1d[0];   gwts[0]  = 1.0;
            gpts1[1]  = gps1d[1];    gpts2[1]  =  gps1d[0];   gpts3[1]  =  gps1d[0];   gwts[1]  = 1.0;
            gpts1[2]  = gps1d[1];    gpts2[2]  =  gps1d[1];   gpts3[2]  =  gps1d[0];   gwts[2]  = 1.0;
            gpts1[3]  = gps1d[0];    gpts2[3]  =  gps1d[1];   gpts3[3]  =  gps1d[0];   gwts[3]  = 1.0;
            gpts1[4]  = gps1d[0];    gpts2[4]  =  gps1d[0];   gpts3[4]  =  gps1d[1];   gwts[4]  = 1.0;
            gpts1[5]  = gps1d[1];    gpts2[5]  =  gps1d[0];   gpts3[5]  =  gps1d[1];   gwts[5]  = 1.0;
            gpts1[6]  = gps1d[1];    gpts2[6]  =  gps1d[1];   gpts3[6]  =  gps1d[1];   gwts[6]  = 1.0;
            gpts1[7]  = gps1d[0];    gpts2[7]  =  gps1d[1];   gpts3[7]  =  gps1d[1];   gwts[7]  = 1.0;

            break;

        case 27:  //27 Point quadrature rule

            gpts1[0]  = gps1d[0];    gpts2[0]  = gps1d[0];    gpts3[0]  = gps1d[0];    gwts[0]  = gws1d[0]*gws1d[0]*gws1d[0];
            gpts1[8]  = gps1d[2];    gpts2[8]  = gps1d[0];    gpts3[8]  = gps1d[0];    gwts[8]  = gws1d[2]*gws1d[0]*gws1d[0];
            gpts1[1]  = gps1d[1];    gpts2[1]  = gps1d[0];    gpts3[1]  = gps1d[0];    gwts[1]  = gws1d[1]*gws1d[0]*gws1d[0];
            gpts1[9]  = gps1d[0];    gpts2[9]  = gps1d[2];    gpts3[9]  = gps1d[0];    gwts[9]  = gws1d[0]*gws1d[2]*gws1d[0];
            gpts1[20] = gps1d[2];    gpts2[20] = gps1d[2];    gpts3[20] = gps1d[0];    gwts[20] = gws1d[2]*gws1d[2]*gws1d[0];
            gpts1[11] = gps1d[1];    gpts2[11] = gps1d[2];    gpts3[11] = gps1d[0];    gwts[11] = gws1d[1]*gws1d[2]*gws1d[0];
            gpts1[3]  = gps1d[0];    gpts2[3]  = gps1d[1];    gpts3[3]  = gps1d[0];    gwts[3]  = gws1d[0]*gws1d[1]*gws1d[0];
            gpts1[13] = gps1d[2];    gpts2[13] = gps1d[1];    gpts3[13] = gps1d[0];    gwts[13] = gws1d[2]*gws1d[1]*gws1d[0];
            gpts1[2]  = gps1d[1];    gpts2[2]  = gps1d[1];    gpts3[2]  = gps1d[0];    gwts[2]  = gws1d[1]*gws1d[1]*gws1d[0];

            gpts1[4]  = gps1d[0];    gpts2[4]  = gps1d[0];    gpts3[4]  = gps1d[1];    gwts[4]  = gws1d[0]*gws1d[0]*gws1d[1];
            gpts1[16] = gps1d[2];    gpts2[16] = gps1d[0];    gpts3[16] = gps1d[1];    gwts[16] = gws1d[2]*gws1d[0]*gws1d[1];
            gpts1[5]  = gps1d[1];    gpts2[5]  = gps1d[0];    gpts3[5]  = gps1d[1];    gwts[5]  = gws1d[1]*gws1d[0]*gws1d[1];
            gpts1[17] = gps1d[0];    gpts2[17] = gps1d[2];    gpts3[17] = gps1d[1];    gwts[17] = gws1d[0]*gws1d[2]*gws1d[1];
            gpts1[25] = gps1d[2];    gpts2[25] = gps1d[2];    gpts3[25] = gps1d[1];    gwts[25] = gws1d[2]*gws1d[2]*gws1d[1];
            gpts1[18] = gps1d[1];    gpts2[18] = gps1d[2];    gpts3[18] = gps1d[1];    gwts[18] = gws1d[1]*gws1d[2]*gws1d[1];
            gpts1[7]  = gps1d[0];    gpts2[7]  = gps1d[1];    gpts3[7]  = gps1d[1];    gwts[7]  = gws1d[0]*gws1d[1]*gws1d[1];
            gpts1[19] = gps1d[2];    gpts2[19] = gps1d[1];    gpts3[19] = gps1d[1];    gwts[19] = gws1d[2]*gws1d[1]*gws1d[1];
            gpts1[6]  = gps1d[1];    gpts2[6]  = gps1d[1];    gpts3[6]  = gps1d[1];    gwts[6]  = gws1d[1]*gws1d[1]*gws1d[1];

            gpts1[10] = gps1d[0];    gpts2[10] = gps1d[0];    gpts3[10] = gps1d[2];    gwts[10] = gws1d[0]*gws1d[0]*gws1d[2];
            gpts1[21] = gps1d[2];    gpts2[21] = gps1d[0];    gpts3[21] = gps1d[2];    gwts[21] = gws1d[2]*gws1d[0]*gws1d[2];
            gpts1[12] = gps1d[1];    gpts2[12] = gps1d[0];    gpts3[12] = gps1d[2];    gwts[12] = gws1d[1]*gws1d[0]*gws1d[2];
            gpts1[22] = gps1d[0];    gpts2[22] = gps1d[2];    gpts3[22] = gps1d[2];    gwts[22] = gws1d[0]*gws1d[2]*gws1d[2];
            gpts1[26] = gps1d[2];    gpts2[26] = gps1d[2];    gpts3[26] = gps1d[2];    gwts[26] = gws1d[2]*gws1d[2]*gws1d[2];
            gpts1[23] = gps1d[1];    gpts2[23] = gps1d[2];    gpts3[23] = gps1d[2];    gwts[23] = gws1d[1]*gws1d[2]*gws1d[2];
            gpts1[15] = gps1d[0];    gpts2[15] = gps1d[1];    gpts3[15] = gps1d[2];    gwts[15] = gws1d[0]*gws1d[1]*gws1d[2];
            gpts1[24] = gps1d[2];    gpts2[24] = gps1d[1];    gpts3[24] = gps1d[2];    gwts[24] = gws1d[2]*gws1d[1]*gws1d[2];
            gpts1[14] = gps1d[1];    gpts2[14] = gps1d[1];    gpts3[14] = gps1d[2];    gwts[14] = gws1d[1]*gws1d[1]*gws1d[2];
...
void getGaussPointsWedge(int ngp, vector<double>& gps1, vector<double>& gps2, vector<double>& gps3, vector<double>& gws)
{
    ...
    vector<double>  gpst1, gpst2, gwst, gps1d, gws1d;

    switch(ngp)
    {
        case 2:  // 2 Point quadrature rule - 1 for triangle, 2 for the normal direction

            getGaussPointsTriangle(1, gpst1, gpst2, gwst);
            getGaussPoints1D(2, gps1d, gws1d);

            gps1[0] = gpst1[0];    gps2[0] = gpst2[0];    gps3[0] = gps1d[0];    gws[0] = gws1d[0]*gwst[0];
            gps1[1] = gpst1[0];    gps2[1] = gpst2[0];    gps3[1] = gps1d[1];    gws[1] = gws1d[1]*gwst[0];

        break;

        case 9:  // 9 Point quadrature rule - 3 for triangle, 3 for the normal direction

            getGaussPointsTriangle(3, gpst1, gpst2, gwst);
            getGaussPoints1D(3, gps1d, gws1d);

            gps1[0] = gpst1[0];    gps2[0] = gpst2[0];    gps3[0] = gps1d[0];    gws[0] = gws1d[0]*gwst[0];
            gps1[1] = gpst1[1];    gps2[1] = gpst2[1];    gps3[1] = gps1d[0];    gws[1] = gws1d[0]*gwst[1];
            gps1[2] = gpst1[2];    gps2[2] = gpst2[2];    gps3[2] = gps1d[0];    gws[2] = gws1d[0]*gwst[2];

            gps1[3] = gpst1[0];    gps2[3] = gpst2[0];    gps3[3] = gps1d[2];    gws[3] = gws1d[2]*gwst[0];
            gps1[4] = gpst1[1];    gps2[4] = gpst2[1];    gps3[4] = gps1d[2];    gws[4] = gws1d[2]*gwst[1];
            gps1[5] = gpst1[2];    gps2[5] = gpst2[2];    gps3[5] = gps1d[2];    gws[5] = gws1d[2]*gwst[2];

            gps1[6] = gpst1[0];    gps2[6] = gpst2[0];    gps3[6] = gps1d[1];    gws[6] = gws1d[1]*gwst[0];
            gps1[7] = gpst1[1];    gps2[7] = gpst2[1];    gps3[7] = gps1d[1];    gws[7] = gws1d[1]*gwst[1];
            gps1[8] = gpst1[2];    gps2[8] = gpst2[2];    gps3[8] = gps1d[1];    gws[8] = gws1d[1]*gwst[2];

        break;

        default:
            cerr << " invalid value of 'ngp' in getGaussPointsWedge ! " << endl;
        break;
    }
    return;
}
