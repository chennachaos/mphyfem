...
MagnetoMech2DQua221::MagnetoMech2DQua221()
{
  ndim   = 2;
  degree = 2;
  npElem = 9;
...
void MagnetoMech2DQua221::prepareElemData()
{
...
double MagnetoMech2DQua221::computeVolume(bool init)
{
...
int MagnetoMech2DQua221::calcMassMatrix(MatrixXd& Mlocal, bool MassLumping)
{
...
int MagnetoMech2DQua221::calcMassMatrixPressure(MatrixXd& Mlocal, bool MassLumping)
{
...
double  MagnetoMech2DQua221::calcCriticalTimeStep(bool flag)
{
    int  ii;
...
int  MagnetoMech2DQua221::calcStiffnessAndResidualMixed2(MatrixXd& Kup, MatrixXd& Kpu, MatrixXd& Kpp, VectorXd& FlocalU,  VectorXd& FlocalP, bool firstIter)
{
...
int  MagnetoMech2DQua221::calcStiffnessAndResidualElecField(MatrixXd& Kff, VectorXd& FlocalF, bool firstIter)
{
...
int MagnetoMech2DQua221::calcResidual(VectorXd& Flocal)
{
...
int MagnetoMech2DQua221::calcResidualPressure(VectorXd& Flocal)
{
    int gp, ii;
    VectorXd  N(nlbfU), dN_dx(nlbfU), dN_dy(nlbfU);
...
int MagnetoMech2DQua221::solveForPressure()
{
    cout << "'MagnetoMech2DQua221::solveForPressure()' ... not implemented yet " << endl;
...
int  MagnetoMech2DQua221::solveForPressureTIC(VectorXd& matK1, double beta, double dt, VectorXd& Flocal)
{
    cout << "'MagnetoMech2DQua221::solveForPressureTIC()' ... not implemented yet " << endl;
...
int MagnetoMech2DQua221::calcLoadVector(VectorXd& Flocal)
{
...
int MagnetoMech2DQua221::calcInternalForces()
{
  return 0;
}
