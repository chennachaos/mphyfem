...
#include "MagnetoMech3DWedge21.h"
#include "MyTime.h"
...
MagnetoMech3DWedge21::MagnetoMech3DWedge21()
{
...
void MagnetoMech3DWedge21::prepareElemData()
{
...
double MagnetoMech3DWedge21::computeVolume(bool configflag)
{
    double  Jac, param[3];
...
/*
int MagnetoMech3DWedge21::calcMassMatrix(MatrixXd& Mlocal, bool MassLumping)
{
...
int MagnetoMech3DWedge21::calcMassMatrixPressure(MatrixXd& Mlocal, bool MassLumping)
{
...
double  MagnetoMech3DWedge21::calcCriticalTimeStep(bool flag)
{
    int  ii, jj, gp;
/*
...
int MagnetoMech3DWedge21::calcStiffnessAndResidualMixed2(MatrixXd& Kup, MatrixXd& Kpu, MatrixXd& Kpp, VectorXd& Flocal1, VectorXd& Flocal2, bool firstIter)
{
...
int MagnetoMech3DWedge21::calcResidual(VectorXd& Flocal)
{
...
int MagnetoMech3DWedge21::calcResidualPressure(VectorXd& Flocal)
{
    int gp, ii;
    VectorXd  N(nlbfU), dN_dx(nlbfU), dN_dy(nlbfU), dN_dz(nlbfU);
...
int MagnetoMech3DWedge21::calcLoadVector(VectorXd& Flocal)
{
  return 0;
}
...
int MagnetoMech3DWedge21::calcInternalForces()
{
  return 0;
}
