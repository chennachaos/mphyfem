...
MagnetoMech3DHex21::MagnetoMech3DHex21()
{
...
void MagnetoMech3DHex21::prepareElemData()
{
...
double MagnetoMech3DHex21::computeVolume(bool configflag)
{
    double  Jac, param[3];
...
int MagnetoMech3DHex21::calcMassMatrixPressure(MatrixXd& Mlocal, bool MassLumping)
{
...
double  MagnetoMech3DHex21::calcCriticalTimeStep(bool flag)
{
    int  ii, jj, gp;
/*
...
int MagnetoMech3DHex21::calcStiffnessAndResidualMixed2(MatrixXd& Kup, MatrixXd& Kpu, MatrixXd& Kpp, VectorXd& Flocal1, VectorXd& Flocal2, bool firstIter)
{
...
int MagnetoMech3DHex21::calcResidual(VectorXd& Flocal)
{
...
int MagnetoMech3DHex21::calcResidualPressure(VectorXd& Flocal)
{
    int gp, ii;
    VectorXd  N(nlbfU), dN_dx(nlbfU), dN_dy(nlbfU), dN_dz(nlbfU);
...
int MagnetoMech3DHex21::calcLoadVector(VectorXd& Flocal)
{
  return 0;
}
...
int MagnetoMech3DHex21::calcInternalForces()
{
  return 0;
}
