...
#ifndef incl_MagnetoMech3DWedge221_h
#define incl_MagnetoMech3DWedge221_h


#include "MagnetoMech3DMixedBase221.h"


class  MagnetoMech3DWedge221 : public MagnetoMech3DMixedBase221
{
  private:
    int  AlgoType;
  ...
  public:
    ...
    MagnetoMech3DWedge221();

    virtual ~MagnetoMech3DWedge221();
