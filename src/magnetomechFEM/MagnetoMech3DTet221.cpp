...
MagnetoMech3DTet221::MagnetoMech3DTet221()
{
  ndim   = 3;
  degree = 2;
  npElem = 10;
...
void MagnetoMech3DTet221::prepareElemData()
{
...
double MagnetoMech3DTet221::computeVolume(bool configflag)
{
    double  Jac, param[3];
...
int MagnetoMech3DTet221::calcMassMatrix(MatrixXd& Mlocal, bool MassLumping)
{
...
int MagnetoMech3DTet221::calcLoadVector(VectorXd& Flocal)
{
  return 0;
}
...
double  MagnetoMech3DTet221::calcCriticalTimeStep(bool flag)
{
    int  ii;
...
int MagnetoMech3DTet221::calcMassMatrixPressure(MatrixXd& Mlocal, bool MassLumping)
{
...
int MagnetoMech3DTet221::calcStiffnessAndResidualMixed2(MatrixXd& Kup, MatrixXd& Kpu, MatrixXd& Kpp, VectorXd& FlocalU,  VectorXd& FlocalP, bool firstIter)
{
...
int  MagnetoMech3DTet221::calcStiffnessAndResidualElecField(MatrixXd& Kff, VectorXd& FlocalF, bool firstIter)
{
...
int MagnetoMech3DTet221::calcResidual(VectorXd& Flocal)
{
...
int MagnetoMech3DTet221::calcInternalForces()
{
  return 0;
}
