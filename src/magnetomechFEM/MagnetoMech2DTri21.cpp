...
MagnetoMech2DTri21::MagnetoMech2DTri21()
{
...
void MagnetoMech2DTri21::prepareElemData()
{
...
double MagnetoMech2DTri21::computeVolume(bool init)
{
...
int MagnetoMech2DTri21::calcMassMatrix(MatrixXd& Mlocal, bool MassLumping)
{
...
int MagnetoMech2DTri21::calcMassMatrixPressure(MatrixXd& Mlocal, bool MassLumping)
{
...
double  MagnetoMech2DTri21::calcCriticalTimeStep(bool flag)
{
    int  ii;
...
int MagnetoMech2DTri21::calcStiffnessAndResidualMixed2(MatrixXd& Kup, MatrixXd& Kpu, MatrixXd& Kpp, VectorXd& Flocal1, VectorXd& Flocal2, bool firstIter)
{
...
int MagnetoMech2DTri21::calcResidual(VectorXd& Flocal)
{
...
int MagnetoMech2DTri21::calcResidualPressure(VectorXd& Flocal)
{
    int gp, ii;
    VectorXd  N(nlbfU), dN_dx(nlbfU), dN_dy(nlbfU);
...
int MagnetoMech2DTri21::solveForPressure()
{
    cout << "'MagnetoMech2DTri21::solveForPressure()' ... not implemented yet " << endl;
...
int MagnetoMech2DTri21::calcLoadVector(VectorXd& Flocal)
{
...
int MagnetoMech2DTri21::calcInternalForces()
{
  return 0;
}
