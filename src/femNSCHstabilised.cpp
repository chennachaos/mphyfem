...
int main(int argc, char* argv[])
{
    ...
    string  configfilefluid  = "./inputs/config.fluid";
    string  configfilephase  = "./inputs/config.phase";
    ...
    cfdfem.readConfiguration(configfile, configfilefluid, configfilephase);
