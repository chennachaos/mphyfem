...
Matl_Gent_Viscoelastic::Matl_Gent_Viscoelastic()
{
...
int Matl_Gent_Viscoelastic::computeStressAndTangent(bool tangFlag, int sss,  MatrixXd&  Fn, MatrixXd&  F, double& pres, VectorXd&  stre, MatrixXd&  Cmat, InternalVariables& ivar, int gp, double dt)
{
    ...
    SetTimeParametersFluid(tis, SolnData->getSpectralRadius(), dt, td);
...
int Matl_Gent_Viscoelastic::computeMechanicalStress(MatrixXd&  F, double&  pres, VectorXd&  stre)
{
    double  r1d3 = 1.0/3.0;
    double  r2d3 = 2.0/3.0;
    double  r5d3 = 5.0/3.0;
