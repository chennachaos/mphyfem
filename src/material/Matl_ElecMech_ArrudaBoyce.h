#ifndef incl_Matl_ElecMech_ArrudaBoyce_h
#define incl_Matl_ElecMech_ArrudaBoyce_h

#include "MaterialBase.h"
#include "headersEigen.h"


class Matl_ElecMech_ArrudaBoyce : public MaterialBase
{
  public:

    //member functions

    Matl_ElecMech_ArrudaBoyce();

    virtual ~Matl_ElecMech_ArrudaBoyce();
