#ifndef incl_Matl_MagnMech_Gent_Viscoelastic_h
#define incl_Matl_MagnMech_Gent_Viscoelastic_h

#include "MaterialBase.h"
#include "headersEigen.h"


class Matl_MagnMech_Gent_Viscoelastic : public MaterialBase
{
  public:

    //member functions

    Matl_MagnMech_Gent_Viscoelastic();

    virtual ~Matl_MagnMech_Gent_Viscoelastic();
