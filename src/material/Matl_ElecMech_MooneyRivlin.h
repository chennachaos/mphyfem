#ifndef incl_Matl_ElecMech_MooneyRivlin_h
#define incl_Matl_ElecMech_MooneyRivlin_h

#include "MaterialBase.h"
#include "headersEigen.h"


class Matl_ElecMech_MooneyRivlin : public MaterialBase
{
  public:

    //member functions

    Matl_ElecMech_MooneyRivlin();

    virtual ~Matl_ElecMech_MooneyRivlin();
