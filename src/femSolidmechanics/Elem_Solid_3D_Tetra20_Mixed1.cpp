...
void Elem_Solid_3D_Tetra20_Mixed1::prepareElemData()
{
  ...
  if(npElem != 20)
  {
     throw runtime_error("Elem_Solid_3D_Tetra20_Mixed1::prepareElemData() ... invalid element type");
  }
...
int Elem_Solid_3D_Tetra20_Mixed1::calcMassMatrix(MatrixXd& Mlocal, bool MassLumping)
{
  return 0;
}
...
int Elem_Solid_3D_Tetra20_Mixed1::calcStiffnessAndResidualMixed(MatrixXd& Kuu, MatrixXd& Kup, MatrixXd& Kpu, MatrixXd& Kpp, VectorXd& FlocalU, VectorXd& FlocalP)
{
    ElementBase::calcStiffnessAndResidualMixed3D(Kuu, Kup, Kpu, Kpp, FlocalU, FlocalP);
...
void Elem_Solid_3D_Tetra20_Mixed1::elementContourplot(int vartype, int varindex, int index)
{
   double outval[50];
   ...
   switch(vartype)
   {
       ...
       default:
              ...
              cout  << " Invalid Variable Type to project in 'Elem_Solid_3D_Tetra20_Mixed1::projectToNodes'" << endl;
              break;
    }
...
void Elem_Solid_3D_Tetra20_Mixed1::projectToNodes(bool extrapolateFlag, int vartype, int varindex, int index)
{
   double outval[50];
...
void Elem_Solid_3D_Tetra20_Mixed1::projectStress(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
    int  err = 0, ii, jj, gp;
...
void Elem_Solid_3D_Tetra20_Mixed1::projectStrain(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
  return;
}
...
void Elem_Solid_3D_Tetra20_Mixed1::projectInternalVariable(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
