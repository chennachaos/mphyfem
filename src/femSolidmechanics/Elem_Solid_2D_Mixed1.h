...
#ifndef incl_Elem_Solid_2D_Mixed1_h
#define incl_Elem_Solid_2D_Mixed1_h


#include "ElementBase.h"


class  Elem_Solid_2D_Mixed1 : public ElementBase
{
  public:

    Elem_Solid_2D_Mixed1();

    virtual ~Elem_Solid_2D_Mixed1();

    virtual int getElmTypeNameNum()
    {
      return ELEM_SOLID_2D_MIXED1;
    }
