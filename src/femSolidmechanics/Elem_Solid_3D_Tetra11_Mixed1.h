...
#ifndef incl_Elem_Solid_3D_Tetra11_Mixed1_h
#define incl_Elem_Solid_3D_Tetra11_Mixed1_h


#include "ElementBase.h"


class  Elem_Solid_3D_Tetra11_Mixed1 : public ElementBase
{
  public:

    Elem_Solid_3D_Tetra11_Mixed1();

    virtual ~Elem_Solid_3D_Tetra11_Mixed1();

    virtual int getElmTypeNameNum()
    {
      return ELEM_SOLID_3D_TETRA11_MIXED1;
    }
