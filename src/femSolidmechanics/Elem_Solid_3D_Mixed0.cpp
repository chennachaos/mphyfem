...
void Elem_Solid_3D_Mixed0::prepareElemData()
{
  /*
  ...
  */
  ...
  {
     throw runtime_error("Elem_Solid_3D_Mixed0::prepareElemData() ... invalid element type");
  }
...
int Elem_Solid_3D_Mixed0::calcMassMatrix(MatrixXd& Mlocal, bool MassLumping)
{
  return 0;
}
...
int Elem_Solid_3D_Mixed0::calcStiffnessAndResidual(MatrixXd& Klocal, VectorXd& Flocal)
{
    ElementBase::calcStiffnessAndResidualMixed3D(Klocal, Kup, Kpu, Kpp, Flocal, FlocalPres);
...
int Elem_Solid_3D_Mixed0::solveForPressure()
{
...
void Elem_Solid_3D_Mixed0::elementContourplot(int vartype, int varindex, int index)
{
   double outval[50];
   ...
   switch(vartype)
   {
       ...
       default:
              ...
              cout  << " Invalid Variable Type to project in 'Elem_Solid_3D_Mixed0::projectToNodes'" << endl;
              break;
    }
...
void Elem_Solid_3D_Mixed0::projectToNodes(bool extrapolateFlag, int vartype, int varindex, int index)
{
   double outval[50];
...
void Elem_Solid_3D_Mixed0::projectStress(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
    int  err = 0, ii, jj, gp;
...
void Elem_Solid_3D_Mixed0::projectStrain(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
  return;
}
...
void Elem_Solid_3D_Mixed0::projectInternalVariable(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
