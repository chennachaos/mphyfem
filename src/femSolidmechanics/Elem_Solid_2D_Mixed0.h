...
#ifndef incl_Elem_Solid_2D_Mixed0_h
#define incl_Elem_Solid_2D_Mixed0_h


#include "ElementBase.h"


class  Elem_Solid_2D_Mixed0 : public ElementBase
{
  public:

    Elem_Solid_2D_Mixed0();

    virtual ~Elem_Solid_2D_Mixed0();

    virtual int getElmTypeNameNum()
    {
      return ELEM_SOLID_2D_MIXED0;
    }
