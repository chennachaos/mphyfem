...
GrowthElem3DHex10::GrowthElem3DHex10()
{
...
void GrowthElem3DHex10::prepareElemData()
{
...
int GrowthElem3DHex10::calcMassMatrixPressure(MatrixXd& Mlocal, bool MassLumping)
{
...
int GrowthElem3DHex10::calcInternalForces()
{
...
void GrowthElem3DHex10::elementContourplot(int vartype, int varindex, int index)
{
   double outval[50];
   ...
   switch(vartype)
   {
       ...
       default:
              ...
              cout  << " Invalid Variable Type to project in 'GrowthElem3DHex10::projectToNodes'" << endl;
              break;
    }
...
void GrowthElem3DHex10::projectToNodes(bool extrapolateFlag, int vartype, int varindex, int index)
{
   double outval[50];
...
void GrowthElem3DHex10::projectStress(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
...
void GrowthElem3DHex10::projectStrain(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
  return;
}
