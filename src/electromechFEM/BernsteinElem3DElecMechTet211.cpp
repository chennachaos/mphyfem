...
#include "BernsteinElem3DElecMechTet211.h"
#include "MyTime.h"
...
BernsteinElem3DElecMechTet211::BernsteinElem3DElecMechTet211()
{
  ndim   = 3;
  degree = 2;
  npElem = 10;
...
void BernsteinElem3DElecMechTet211::prepareElemData()
{
...
double BernsteinElem3DElecMechTet211::computeVolume(bool configflag)
{
    double  Jac, param[3];
...
int BernsteinElem3DElecMechTet211::calcMassMatrix(MatrixXd& Mlocal, bool MassLumping)
{
...
int BernsteinElem3DElecMechTet211::calcLoadVector(VectorXd& Flocal)
{
  return 0;
}
...
double  BernsteinElem3DElecMechTet211::calcCriticalTimeStep(bool flag)
{
    int  ii;
...
int BernsteinElem3DElecMechTet211::calcMassMatrixPressure(MatrixXd& Mlocal, bool MassLumping)
{
...
int  BernsteinElem3DElecMechTet211::calcStiffnessAndResidualMixed(MatrixXd& Kuu, MatrixXd& Kuf, MatrixXd& Kfu, MatrixXd& Kff, MatrixXd& Kup, MatrixXd& Kpu, MatrixXd& Kpp, VectorXd& FlocalU, VectorXd& FlocalF, VectorXd& FlocalP, bool firstIter)
{
...
int BernsteinElem3DElecMechTet211::calcStiffnessAndResidualMixed2(MatrixXd& Kup, MatrixXd& Kpu, MatrixXd& Kpp, VectorXd& FlocalU,  VectorXd& FlocalP, bool firstIter)
{
    int   err,  isw,  count,  count1, index, ii, jj, kk, ll, mm, gp, TI, TIp1, TIp2, TJ, TJp1, TJp2;
...
int  BernsteinElem3DElecMechTet211::calcStiffnessAndResidualElecField(MatrixXd& Kff, VectorXd& FlocalF, bool firstIter)
{
...
int BernsteinElem3DElecMechTet211::calcResidual(VectorXd& Flocal)
{
...
int BernsteinElem3DElecMechTet211::calcInternalForces()
{
  return 0;
}
...
void BernsteinElem3DElecMechTet211::elementContourplot(int vartype, int varindex, int index)
{
   double outval[50];
...
void BernsteinElem3DElecMechTet211::projectToNodes(bool extrapolateFlag, int vartype, int varindex, int index)
{
   double outval[50];
...
void BernsteinElem3DElecMechTet211::projectStress(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
...
void BernsteinElem3DElecMechTet211::projectStrain(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
  return;
}
...
void BernsteinElem3DElecMechTet211::projectInternalVariable(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
