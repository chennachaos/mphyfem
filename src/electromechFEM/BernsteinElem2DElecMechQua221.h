...
#ifndef incl_BernsteinElem2DElecMechQua221_h
#define incl_BernsteinElem2DElecMechQua221_h


#include "ElementBase.h"


class  BernsteinElem2DElecMechQua221 : public ElementBase
{
  private:
    int  AlgoType;
  ...
  public:
    ...
    BernsteinElem2DElecMechQua221();

    virtual ~BernsteinElem2DElecMechQua221();
