...
#include "BernsteinElem3DElecMechHex221.h"
#include "MyTime.h"
...
BernsteinElem3DElecMechHex221::BernsteinElem3DElecMechHex221()
{
  ndim   = 3;
  degree = 2;
  npElem = 27;
...
void BernsteinElem3DElecMechHex221::prepareElemData()
{
...
double BernsteinElem3DElecMechHex221::computeVolume(bool configflag)
{
    double  Jac, param[3];
...
int BernsteinElem3DElecMechHex221::calcMassMatrix(MatrixXd& Mlocal, bool MassLumping)
{
...
int BernsteinElem3DElecMechHex221::calcLoadVector(VectorXd& Flocal)
{
  return 0;
}
...
double  BernsteinElem3DElecMechHex221::calcCriticalTimeStep(bool flag)
{
    int  ii;
...
int BernsteinElem3DElecMechHex221::calcMassMatrixPressure(MatrixXd& Mlocal, bool MassLumping)
{
...
int  BernsteinElem3DElecMechHex221::calcStiffnessAndResidualMixed(MatrixXd& Kuu, MatrixXd& Kuf, MatrixXd& Kfu, MatrixXd& Kff, MatrixXd& Kup, MatrixXd& Kpu, MatrixXd& Kpp, VectorXd& FlocalU, VectorXd& FlocalF, VectorXd& FlocalP, bool firstIter)
{
...
int BernsteinElem3DElecMechHex221::calcStiffnessAndResidualMixed2(MatrixXd& Kup, MatrixXd& Kpu, MatrixXd& Kpp, VectorXd& FlocalU,  VectorXd& FlocalP, bool firstIter)
{
    int   err,  isw,  count,  count1, index, ii, jj, kk, ll, mm, gp, TI, TIp1, TIp2, TJ, TJp1, TJp2;
...
int  BernsteinElem3DElecMechHex221::calcStiffnessAndResidualElecField(MatrixXd& Kff, VectorXd& FlocalF, bool firstIter)
{
...
int BernsteinElem3DElecMechHex221::calcResidual(VectorXd& Flocal)
{
...
int BernsteinElem3DElecMechHex221::calcInternalForces()
{
  return 0;
}
...
void BernsteinElem3DElecMechHex221::elementContourplot(int vartype, int varindex, int index)
{
   double outval[50];
...
void BernsteinElem3DElecMechHex221::projectToNodes(bool extrapolateFlag, int vartype, int varindex, int index)
{
   double outval[50];
...
void BernsteinElem3DElecMechHex221::projectStress(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
    double  detF, dvol, Jac, fact, dvol0, pbar, param[3], Np[8];
...
void BernsteinElem3DElecMechHex221::projectStrain(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
  return;
}
...
void BernsteinElem3DElecMechHex221::projectInternalVariable(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
