...
#include "BernsteinElem2DElecMechQua221P.h"
#include "MyTime.h"
...
BernsteinElem2DElecMechQua221P::BernsteinElem2DElecMechQua221P()
{
  ndim   = 2;
  degree = 2;
  npElem = 9;
...
void BernsteinElem2DElecMechQua221P::prepareElemData()
{
...
double BernsteinElem2DElecMechQua221P::computeVolume(bool init)
{
...
int BernsteinElem2DElecMechQua221P::calcMassMatrix(MatrixXd& Mlocal, bool MassLumping)
{
...
int BernsteinElem2DElecMechQua221P::calcMassMatrixPressure(MatrixXd& Mlocal, bool MassLumping)
{
...
double  BernsteinElem2DElecMechQua221P::calcCriticalTimeStep(bool flag)
{
    int  ii;
...
int  BernsteinElem2DElecMechQua221P::calcStiffnessAndResidual(MatrixXd& Kuu, MatrixXd& Kuf, MatrixXd& Kfu, MatrixXd& Kff, VectorXd& FlocalU, VectorXd& FlocalF, bool firstIter)
{
    ...
    for(gp=0; gp<nGP; gp++)
    {
        ...
        BernsteinBasisFunsTria(1, 0.5*(1.0+param[0]), 0.5*(1.0+param[1]), Np);
        //Np[0] = 1.0;  Np[1] = param[0];  Np[2] = param[1];
        pres = 0.0;
...
int BernsteinElem2DElecMechQua221P::solveForPressure()
{
...
int  BernsteinElem2DElecMechQua221P::calcStiffnessAndResidualMixed2(MatrixXd& Kup, MatrixXd& Kpu, MatrixXd& Kpp, VectorXd& FlocalU,  VectorXd& FlocalP, bool firstIter)
{
    int   err,  isw,  count,  count1, index, ii, jj, kk, ll, mm, gp, TI, TIp1, TJ, TJp1;
...
int  BernsteinElem2DElecMechQua221P::calcStiffnessAndResidualElecField(MatrixXd& Kff, VectorXd& FlocalF, bool firstIter)
{
...
int BernsteinElem2DElecMechQua221P::calcResidual(VectorXd& Flocal)
{
...
int BernsteinElem2DElecMechQua221P::calcResidualPressure(VectorXd& Flocal)
{
    int gp, ii;
    VectorXd  N(nlbfU), dN_dx(nlbfU), dN_dy(nlbfU);
...
int  BernsteinElem2DElecMechQua221P::solveForPressureTIC(VectorXd& matK1, double beta, double dt, VectorXd& Flocal)
{
    cout << "'BernsteinElem2DElecMechQua221P::solveForPressureTIC()' ... not implemented yet " << endl;
...
int BernsteinElem2DElecMechQua221P::calcLoadVector(VectorXd& Flocal)
{
...
int BernsteinElem2DElecMechQua221P::calcInternalForces()
{
  return 0;
}
...
void BernsteinElem2DElecMechQua221P::elementContourplot(int vartype, int varindex, int index)
{
   double outval[50];
...
void BernsteinElem2DElecMechQua221P::projectToNodes(bool extrapolateFlag, int vartype, int varindex, int index)
{
   double outval[50];
...
void BernsteinElem2DElecMechQua221P::projectStress(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
...
void BernsteinElem2DElecMechQua221P::projectStrain(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
  return;
}
...
void BernsteinElem2DElecMechQua221P::projectInternalVariable(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
