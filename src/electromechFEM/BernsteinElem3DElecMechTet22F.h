...
#ifndef incl_BernsteinElem3DElecMechTet22F_h
#define incl_BernsteinElem3DElecMechTet22F_h


#include "ElementBase.h"


class  BernsteinElem3DElecMechTet22F : public ElementBase
{
  public:

    BernsteinElem3DElecMechTet22F();

    virtual ~BernsteinElem3DElecMechTet22F();
