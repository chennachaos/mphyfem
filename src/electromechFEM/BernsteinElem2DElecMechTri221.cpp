...
#include "BernsteinElem2DElecMechTri221.h"
#include "MyTime.h"
...
BernsteinElem2DElecMechTri221::BernsteinElem2DElecMechTri221()
{
  ndim   = 2;
  degree = 2;
  npElem = 6;
...
void BernsteinElem2DElecMechTri221::prepareElemData()
{
...
double BernsteinElem2DElecMechTri221::computeVolume(bool init)
{
...
int BernsteinElem2DElecMechTri221::calcMassMatrix(MatrixXd& Mlocal, bool MassLumping)
{
...
int BernsteinElem2DElecMechTri221::calcMassMatrixPressure(MatrixXd& Mlocal, bool MassLumping)
{
...
double  BernsteinElem2DElecMechTri221::calcCriticalTimeStep(bool flag)
{
    int  ii;
...
int  BernsteinElem2DElecMechTri221::calcStiffnessAndResidualMixed(MatrixXd& Kuu, MatrixXd& Kuf, MatrixXd& Kfu, MatrixXd& Kff, MatrixXd& Kup, MatrixXd& Kpu, MatrixXd& Kpp, VectorXd& FlocalU, VectorXd& FlocalF, VectorXd& FlocalP, bool firstIter)
{
...
int  BernsteinElem2DElecMechTri221::calcStiffnessAndResidualMixed2(MatrixXd& Kup, MatrixXd& Kpu, MatrixXd& Kpp, VectorXd& FlocalU,  VectorXd& FlocalP, bool firstIter)
{
    int   err,  isw,  count,  count1, index, ii, jj, kk, ll, mm, gp, TI, TIp1, TJ, TJp1;
...
int  BernsteinElem2DElecMechTri221::calcStiffnessAndResidualElecField(MatrixXd& Kff, VectorXd& FlocalF, bool firstIter)
{
...
int BernsteinElem2DElecMechTri221::calcResidual(VectorXd& Flocal)
{
...
int BernsteinElem2DElecMechTri221::calcResidualPressure(VectorXd& Flocal)
{
    int gp, ii;
    VectorXd  N(nlbfU), dN_dx(nlbfU), dN_dy(nlbfU);
...
int BernsteinElem2DElecMechTri221::solveForPressure()
{
    cout << "'BernsteinElem2DElecMechTri221::solveForPressure()' ... not implemented yet " << endl;
...
int  BernsteinElem2DElecMechTri221::solveForPressureTIC(VectorXd& matK1, double beta, double dt, VectorXd& Flocal)
{
    cout << "'BernsteinElem2DElecMechTri221::solveForPressureTIC()' ... not implemented yet " << endl;
...
int BernsteinElem2DElecMechTri221::calcLoadVector(VectorXd& Flocal)
{
...
int BernsteinElem2DElecMechTri221::calcInternalForces()
{
  return 0;
}
...
void BernsteinElem2DElecMechTri221::elementContourplot(int vartype, int varindex, int index)
{
   double outval[50];
...
void BernsteinElem2DElecMechTri221::projectToNodes(bool extrapolateFlag, int vartype, int varindex, int index)
{
   double outval[50];
...
void BernsteinElem2DElecMechTri221::projectStress(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
...
void BernsteinElem2DElecMechTri221::projectStrain(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
  return;
}
...
void BernsteinElem2DElecMechTri221::projectInternalVariable(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
