...
#include "BernsteinElem2DElecMechQua11.h"
#include "MyTime.h"
...
BernsteinElem2DElecMechQua11::BernsteinElem2DElecMechQua11()
{
  ndim   = 2;
  degree = 1;
  npElem = 4;
...
void BernsteinElem2DElecMechQua11::prepareElemData()
{
...
double BernsteinElem2DElecMechQua11::computeVolume(bool configflag)
{
...
int BernsteinElem2DElecMechQua11::calcMassMatrix(MatrixXd& Mlocal, bool MassLumping)
{
...
double  BernsteinElem2DElecMechQua11::calcCriticalTimeStep(bool flag)
{
    int  ii;
...
int BernsteinElem2DElecMechQua11::calcStiffnessAndResidual(MatrixXd& Kuu, MatrixXd& Kuf, MatrixXd& Kfu, MatrixXd& Kff, VectorXd& FlocalU, VectorXd& FlocalF, bool firstIter)
{
...
int BernsteinElem2DElecMechQua11::calcResidual(VectorXd& Flocal)
{
...
int BernsteinElem2DElecMechQua11::calcLoadVector(VectorXd& Flocal)
{
  ...
  for(nn=0; nn<NeumannBCs.size(); nn++)
  {
    ...
    for(gp=0; gp<nGP; gp++)
    {
      ...
      //BernsteinBasisFunsEdge2D(degree, param, xNode, yNode, N, normal, curvature, Jac);
...
int BernsteinElem2DElecMechQua11::calcInternalForces()
{
  return 0;
}
...
void BernsteinElem2DElecMechQua11::elementContourplot(int vartype, int varindex, int index)
{
   double outval[50];
   ...
   switch(vartype)
   {
       ...
       default:
              ...
              cout  << " Invalid Variable Type to project in 'BernsteinElem2DElecMechQua11::projectToNodes'" << endl;
              break;
    }
...
void BernsteinElem2DElecMechQua11::projectToNodes(bool extrapolateFlag, int vartype, int varindex, int index)
{
   double outval[50];
...
void BernsteinElem2DElecMechQua11::projectStress(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
...
void BernsteinElem2DElecMechQua11::projectStrain(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
  return;
}
...
void BernsteinElem2DElecMechQua11::projectInternalVariable(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
