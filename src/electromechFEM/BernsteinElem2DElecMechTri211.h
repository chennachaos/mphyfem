...
#ifndef incl_BernsteinElem2DElecMechTri211_h
#define incl_BernsteinElem2DElecMechTri211_h


#include "ElementBase.h"


class  BernsteinElem2DElecMechTri211 : public ElementBase
{
  private:
    int  AlgoType;
  ...
  public:
    ...
    BernsteinElem2DElecMechTri211();

    virtual ~BernsteinElem2DElecMechTri211();
