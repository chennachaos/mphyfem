...
#include "BernsteinElem3DElecMechHex11.h"
#include "MyTime.h"
...
BernsteinElem3DElecMechHex11::BernsteinElem3DElecMechHex11()
{
  ndim   = 3;
  degree = 1;
  npElem = 8;
...
void BernsteinElem3DElecMechHex11::prepareElemData()
{
...
double BernsteinElem3DElecMechHex11::computeVolume(bool configflag)
{
    double  Jac, param[3];
...
int BernsteinElem3DElecMechHex11::calcMassMatrix(MatrixXd& Mlocal, bool MassLumping)
{
...
int BernsteinElem3DElecMechHex11::calcLoadVector(VectorXd& Flocal)
{
  return 0;
}
...
double  BernsteinElem3DElecMechHex11::calcCriticalTimeStep(bool flag)
{
    int  ii;
...
int BernsteinElem3DElecMechHex11::calcStiffnessAndResidual(MatrixXd& Kuu, MatrixXd& Kuf, MatrixXd& Kfu, MatrixXd& Kff, VectorXd& FlocalU, VectorXd& FlocalF, bool firstIter)
{
...
int BernsteinElem3DElecMechHex11::calcResidual(VectorXd& Flocal)
{
...
int BernsteinElem3DElecMechHex11::calcInternalForces()
{
  return 0;
}
...
void BernsteinElem3DElecMechHex11::elementContourplot(int vartype, int varindex, int index)
{
   double outval[50];
...
void BernsteinElem3DElecMechHex11::projectToNodes(bool extrapolateFlag, int vartype, int varindex, int index)
{
   double outval[50];
...
void BernsteinElem3DElecMechHex11::projectStress(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
...
void BernsteinElem3DElecMechHex11::projectStrain(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
  return;
}
...
void BernsteinElem3DElecMechHex11::projectInternalVariable(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
