...
#include "BernsteinElem3DElecMechTet221.h"
#include "MyTime.h"
...
BernsteinElem3DElecMechTet221::BernsteinElem3DElecMechTet221()
{
  ndim   = 3;
  degree = 2;
  npElem = 10;
...
void BernsteinElem3DElecMechTet221::prepareElemData()
{
...
double BernsteinElem3DElecMechTet221::computeVolume(bool configflag)
{
    double  Jac, param[3];
...
int BernsteinElem3DElecMechTet221::calcMassMatrix(MatrixXd& Mlocal, bool MassLumping)
{
...
int BernsteinElem3DElecMechTet221::calcLoadVector(VectorXd& Flocal)
{
  return 0;
}
...
double  BernsteinElem3DElecMechTet221::calcCriticalTimeStep(bool flag)
{
    int  ii;
...
int BernsteinElem3DElecMechTet221::calcMassMatrixPressure(MatrixXd& Mlocal, bool MassLumping)
{
...
int  BernsteinElem3DElecMechTet221::calcStiffnessAndResidualMixed(MatrixXd& Kuu, MatrixXd& Kuf, MatrixXd& Kfu, MatrixXd& Kff, MatrixXd& Kup, MatrixXd& Kpu, MatrixXd& Kpp, VectorXd& FlocalU, VectorXd& FlocalF, VectorXd& FlocalP, bool firstIter)
{
    ...
    for(gp=0; gp<nGP; gp++)
    {
        ...
        {
          pres += (Np[ii]*SolnData->var2Cur[nodeNums[ii]]);
        }
...
int BernsteinElem3DElecMechTet221::calcStiffnessAndResidualMixed2(MatrixXd& Kup, MatrixXd& Kpu, MatrixXd& Kpp, VectorXd& FlocalU,  VectorXd& FlocalP, bool firstIter)
{
    int   err,  isw,  count,  count1, index, ii, jj, kk, ll, mm, gp, TI, TIp1, TIp2, TJ, TJp1, TJp2;
...
int  BernsteinElem3DElecMechTet221::calcStiffnessAndResidualElecField(MatrixXd& Kff, VectorXd& FlocalF, bool firstIter)
{
    ...
    for(gp=0; gp<nGP; gp++)
    {
        ...
        GeomData->computeBasisFunctions3D(CONFIG_DEFORMED, ELEM_SHAPE_TETRA_BERNSTEIN, degree, param, nodeNums, &Nf(0), &dNf_dx(0), &dNf_dy(0), &dNf_dz(0), Jac);
...
int BernsteinElem3DElecMechTet221::calcResidual(VectorXd& Flocal)
{
...
int BernsteinElem3DElecMechTet221::calcInternalForces()
{
  return 0;
}
...
void BernsteinElem3DElecMechTet221::elementContourplot(int vartype, int varindex, int index)
{
   double outval[50];
...
void BernsteinElem3DElecMechTet221::projectToNodes(bool extrapolateFlag, int vartype, int varindex, int index)
{
   double outval[50];
...
void BernsteinElem3DElecMechTet221::projectStress(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
...
void BernsteinElem3DElecMechTet221::projectStrain(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
  return;
}
...
void BernsteinElem3DElecMechTet221::projectInternalVariable(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
