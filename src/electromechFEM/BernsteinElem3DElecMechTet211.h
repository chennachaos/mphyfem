...
#ifndef incl_BernsteinElem3DElecMechTet211_h
#define incl_BernsteinElem3DElecMechTet211_h


#include "ElementBase.h"


class  BernsteinElem3DElecMechTet211 : public ElementBase
{
  private:
    int  AlgoType;
  ...
  public:
    ...
    BernsteinElem3DElecMechTet211();

    virtual ~BernsteinElem3DElecMechTet211();
