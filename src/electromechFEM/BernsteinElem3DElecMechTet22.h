...
#ifndef incl_BernsteinElem3DElecMechTet22_h
#define incl_BernsteinElem3DElecMechTet22_h


#include "ElementBase.h"


class  BernsteinElem3DElecMechTet22 : public ElementBase
{
  public:

    BernsteinElem3DElecMechTet22();

    virtual ~BernsteinElem3DElecMechTet22();
