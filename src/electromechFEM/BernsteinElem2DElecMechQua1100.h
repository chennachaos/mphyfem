...
#ifndef incl_BernsteinElem2DElecMechQua1100_h
#define incl_BernsteinElem2DElecMechQua1100_h


#include "ElementBase.h"


class  BernsteinElem2DElecMechQua1100 : public ElementBase
{
  private:
    int  AlgoType;
  ...
  public:
    ...
    BernsteinElem2DElecMechQua1100();

    virtual ~BernsteinElem2DElecMechQua1100();
