...
#include "BernsteinElem3DElecMechTet22.h"
#include "MyTime.h"
...
BernsteinElem3DElecMechTet22::BernsteinElem3DElecMechTet22()
{
  ndim   = 3;
  degree = 2;
  npElem = 10;
...
void BernsteinElem3DElecMechTet22::prepareElemData()
{
...
double BernsteinElem3DElecMechTet22::computeVolume(bool configflag)
{
    double  Jac, param[3];
...
int BernsteinElem3DElecMechTet22::calcMassMatrix(MatrixXd& Mlocal, bool MassLumping)
{
...
int BernsteinElem3DElecMechTet22::calcLoadVector(VectorXd& Flocal)
{
  return 0;
}
...
double  BernsteinElem3DElecMechTet22::calcCriticalTimeStep(bool flag)
{
    int  ii;
...
int BernsteinElem3DElecMechTet22::calcStiffnessAndResidual(MatrixXd& Kuu, MatrixXd& Kuf, MatrixXd& Kfu, MatrixXd& Kff, VectorXd& FlocalU, VectorXd& FlocalF, bool firstIter)
{
...
int BernsteinElem3DElecMechTet22::calcResidual(VectorXd& Flocal)
{
...
int BernsteinElem3DElecMechTet22::calcInternalForces()
{
  return 0;
}
...
void BernsteinElem3DElecMechTet22::elementContourplot(int vartype, int varindex, int index)
{
   double outval[50];
...
void BernsteinElem3DElecMechTet22::projectToNodes(bool extrapolateFlag, int vartype, int varindex, int index)
{
   double outval[50];
...
void BernsteinElem3DElecMechTet22::projectStress(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
    double  detF, dvol, Jac, fact, dvol0, param[3];
    ...
    for(gp=0; gp<nGP; gp++)
    {
        ...
        {
          //VectorXcd eivals = Fmat.eigenvalues();
...
void BernsteinElem3DElecMechTet22::projectStrain(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
  return;
}
...
void BernsteinElem3DElecMechTet22::projectInternalVariable(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
