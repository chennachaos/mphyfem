...
#ifndef incl_BernsteinElem3DElecMechTet220_h
#define incl_BernsteinElem3DElecMechTet220_h


#include "ElementBase.h"


class  BernsteinElem3DElecMechTet220 : public ElementBase
{
  private:
    int  AlgoType;
  ...
  public:
    ...
    BernsteinElem3DElecMechTet220();

    virtual ~BernsteinElem3DElecMechTet220();
