...
#ifndef incl_BernsteinElem2DEdge2Node_h
#define incl_BernsteinElem2DEdge2Node_h


#include "ElementBase.h"


class  BernsteinElem2DEdge2Node : public ElementBase
{
  public:

    BernsteinElem2DEdge2Node();

    virtual ~BernsteinElem2DEdge2Node();
