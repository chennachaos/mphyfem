...
GrowthElem2DQua10::GrowthElem2DQua10()
{
...
void GrowthElem2DQua10::prepareElemData()
{
...
double GrowthElem2DQua10::computeVolume(bool configflag)
{
...
int GrowthElem2DQua10::calcMassMatrix(MatrixXd& Mlocal, bool MassLumping)
{
...
int GrowthElem2DQua10::calcMassMatrixPressure(MatrixXd& Mlocal, bool MassLumping)
{
...
double  GrowthElem2DQua10::calcCriticalTimeStep(bool flag)
{
    int  ii;
...
int GrowthElem2DQua10::calcStiffnessAndResidual(MatrixXd& Kuu, VectorXd& FlocalU, bool firstIter)
{
    ...
    for(gp=0; gp<nGP; gp++)
    {
        ...
        if(finite)
        {
          Rp(0) += (detF - Jg*(Jhat+thetahat*pres)) *dvol0;
        }
        else
        {
...
int GrowthElem2DQua10::solveForPressure()
{
...
int GrowthElem2DQua10::calcStiffnessAndResidualMixed2(MatrixXd& Kup, MatrixXd& Kpu, MatrixXd& Kpp, VectorXd& Flocal1, VectorXd& Flocal2, bool firstIter)
{
    int   err,  isw,  count,  count1, index, ii, jj, kk, ll, mm, gp, TI, TIp1, TJ, TJp1;
...
int GrowthElem2DQua10::calcResidual(VectorXd& Flocal)
{
    int   err,  isw,  count,  count1, index, ii, jj, kk, ll, mm, gp, TI, TIp1, TJ, TJp1;
...
int GrowthElem2DQua10::calcResidualPressure(VectorXd& Flocal)
{
    int gp, ii;
    VectorXd  N(nlbfU), dN_dx(nlbfU), dN_dy(nlbfU);
...
int GrowthElem2DQua10::calcLoadVector(VectorXd& Flocal)
{
...
int GrowthElem2DQua10::calcInternalForces()
{
...
void GrowthElem2DQua10::elementContourplot(int vartype, int varindex, int index)
{
   double outval[50];
   ...
   switch(vartype)
   {
       ...
       default:
              ...
              cout  << " Invalid Variable Type to project in 'GrowthElem2DQua10::projectToNodes'" << endl;
              break;
    }
...
void GrowthElem2DQua10::projectToNodes(bool extrapolateFlag, int vartype, int varindex, int index)
{
   double outval[50];
...
void GrowthElem2DQua10::projectStress(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
...
void GrowthElem2DQua10::projectStrain(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
  return;
}
...
void GrowthElem2DQua10::projectInternalVariable(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
...
int  GrowthElem2DQua10::calcError(int index)
{
    // compute error
    ///////////////////////////////////////////////////////////
