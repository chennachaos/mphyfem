...
GrowthElem2DTri21::GrowthElem2DTri21()
{
...
void GrowthElem2DTri21::prepareElemData()
{
...
double GrowthElem2DTri21::computeVolume(bool init)
{
...
int GrowthElem2DTri21::calcMassMatrix(MatrixXd& Mlocal, bool MassLumping)
{
...
int GrowthElem2DTri21::calcMassMatrixPressure(MatrixXd& Mlocal, bool MassLumping)
{
...
double  GrowthElem2DTri21::calcCriticalTimeStep(bool flag)
{
    int  ii;
...
int GrowthElem2DTri21::calcForceVectorGrowthModel(VectorXd& Flocal1, VectorXd& Flocal2)
{
...
int GrowthElem2DTri21::calcStiffnessAndResidualMixed2(MatrixXd& Kup, MatrixXd& Kpu, MatrixXd& Kpp, VectorXd& Flocal1, VectorXd& Flocal2, bool firstIter)
{
...
int GrowthElem2DTri21::calcResidual(VectorXd& Flocal)
{
...
int GrowthElem2DTri21::calcResidualPressure(VectorXd& Flocal)
{
    int gp, ii;
    VectorXd  N(nlbfU), dN_dx(nlbfU), dN_dy(nlbfU);
...
int GrowthElem2DTri21::solveForPressure()
{
    cout << "'GrowthElem2DTri21::solveForPressure()' ... not implemented yet " << endl;
...
int GrowthElem2DTri21::calcLoadVector(VectorXd& Flocal)
{
  ...
  double  specVal, xNode[6], yNode[6], xx, yy, param[2], trac[2], normal[2], tang[2], N[3], dNdx[3], dNdy[3];
...
int GrowthElem2DTri21::calcInternalForces()
{
  return 0;
}
...
void GrowthElem2DTri21::elementContourplot(int vartype, int varindex, int index)
{
   double outval[50];
   ...
   switch(vartype)
   {
       ...
       default:
              ...
              cout  << " Invalid Variable Type to project in 'GrowthElem2DTri21::projectToNodes'" << endl;
              break;
    }
...
void GrowthElem2DTri21::projectToNodes(bool extrapolateFlag, int vartype, int varindex, int index)
{
   double outval[50];
...
void GrowthElem2DTri21::projectStress(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
...
void GrowthElem2DTri21::projectStrain(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
  return;
}
...
void GrowthElem2DTri21::projectInternalVariable(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
...
int  GrowthElem2DTri21::calcError(int index)
{
    // compute error
    ///////////////////////////////////////////////////////////
