...
GrowthElem2DQua21P::GrowthElem2DQua21P()
{
...
void GrowthElem2DQua21P::prepareElemData()
{
...
double GrowthElem2DQua21P::computeVolume(bool init)
{
...
int GrowthElem2DQua21P::calcMassMatrix(MatrixXd& Mlocal, bool MassLumping)
{
...
int GrowthElem2DQua21P::calcMassMatrixPressure(MatrixXd& Mlocal, bool MassLumping)
{
...
double  GrowthElem2DQua21P::calcCriticalTimeStep(bool flag)
{
    int  ii;
...
int  GrowthElem2DQua21P::calcStiffnessAndResidual(MatrixXd& Kuu, VectorXd& FlocalU, bool firstIter)
{
    int   err,  isw,  count,  count1, index, ii, jj, kk, ll, mm, gp, TI, TIp1, TJ, TJp1;

    VectorXd  N(nlbfU), dN_dx(nlbfU), dN_dy(nlbfU);

    double  detF, detFn, fact, fact1, dvol, dvol0, Jac, volstrain, r2d3=2.0/3.0;
    double  bb1, bb2, bb3, bb4, bb5, cc1, cc2, cc3, cc4, cc5, dUdJ, d2UdJ2, Jhat, thetahat;
    double  param[2], bforce[2], force[2];
    double  veloCur[2], acceCur[2], sig[2], Np[3];
    ...
    for(gp=0; gp<nGP; gp++)
    {
        ...
        if(finite)
        {
          ...
          fact = detF - Jg*(Jhat+thetahat*pres);
        }
        else
        {
...
int GrowthElem2DQua21P::solveForPressure()
{
...
int GrowthElem2DQua21P::calcForceVectorGrowthModel(VectorXd& Flocal1, VectorXd& Flocal2)
{
...
int GrowthElem2DQua21P::calcStiffnessAndResidualMixed2(MatrixXd& Kup, MatrixXd& Kpu, MatrixXd& Kpp, VectorXd& Flocal1, VectorXd& Flocal2, bool firstIter)
{
    int   err,  isw,  count,  count1, index, ii, jj, kk, ll, mm, gp, TI, TIp1, TJ, TJp1;
...
int GrowthElem2DQua21P::calcResidual(VectorXd& Flocal)
{
...
int GrowthElem2DQua21P::calcResidualPressure(VectorXd& Flocal)
{
    int gp, ii;
    VectorXd  N(nlbfU), dN_dx(nlbfU), dN_dy(nlbfU);
...
int GrowthElem2DQua21P::calcLoadVector(VectorXd& Flocal)
{
...
int GrowthElem2DQua21P::calcInternalForces()
{
  return 0;
}
...
void GrowthElem2DQua21P::elementContourplot(int vartype, int varindex, int index)
{
   double outval[50];
   ...
   switch(vartype)
   {
       ...
       default:
              ...
              cout  << " Invalid Variable Type to project in 'GrowthElem2DQua21P::projectToNodes'" << endl;
              break;
    }
...
void GrowthElem2DQua21P::projectToNodes(bool extrapolateFlag, int vartype, int varindex, int index)
{
   double outval[50];
...
void GrowthElem2DQua21P::projectStress(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
...
void GrowthElem2DQua21P::projectStrain(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
  return;
}
...
void GrowthElem2DQua21P::projectInternalVariable(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
...
int  GrowthElem2DQua21P::calcError(int index)
{
    // compute error
    ///////////////////////////////////////////////////////////
  ...
  double  F[4], detF, F33, streExac[4], streNum[4], cc[4][4], Np[nlbfP];
