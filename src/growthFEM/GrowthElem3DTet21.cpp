...
GrowthElem3DTet21::GrowthElem3DTet21()
{
...
void GrowthElem3DTet21::prepareElemData()
{
...
double GrowthElem3DTet21::computeVolume(bool configflag)
{
    double  Jac, param[3];
...
int GrowthElem3DTet21::calcMassMatrix(MatrixXd& Mlocal, bool MassLumping)
{
...
int GrowthElem3DTet21::calcMassMatrixPressure(MatrixXd& Mlocal, bool MassLumping)
{
...
double  GrowthElem3DTet21::calcCriticalTimeStep(bool flag)
{
    int  ii, jj, gp;
/*
...
int GrowthElem3DTet21::calcStiffnessAndResidualMixed2(MatrixXd& Kup, MatrixXd& Kpu, MatrixXd& Kpp, VectorXd& Flocal1, VectorXd& Flocal2, bool firstIter)
{
...
int GrowthElem3DTet21::calcResidual(VectorXd& Flocal)
{
...
int GrowthElem3DTet21::calcResidualPressure(VectorXd& Flocal)
{
    int gp, ii;
    VectorXd  N(nlbfU), dN_dx(nlbfU), dN_dy(nlbfU), dN_dz(nlbfU);
...
int GrowthElem3DTet21::calcLoadVector(VectorXd& Flocal)
{
  return 0;
}
...
int GrowthElem3DTet21::calcInternalForces()
{
  return 0;
}
...
void GrowthElem3DTet21::elementContourplot(int vartype, int varindex, int index)
{
   double outval[50];
   ...
   switch(vartype)
   {
       ...
       default:
              ...
              cout  << " Invalid Variable Type to project in 'GrowthElem3DTet21::projectToNodes'" << endl;
              break;
    }
...
void GrowthElem3DTet21::projectToNodes(bool extrapolateFlag, int vartype, int varindex, int index)
{
   double outval[50];
...
void GrowthElem3DTet21::projectStress(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
    double  detF, fact, dvol, dvol0, Jac, param[3], Np[4], r1d3 = 1.0/3.0;
...
void GrowthElem3DTet21::projectStrain(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
  return;
}
...
void GrowthElem3DTet21::projectInternalVariable(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
