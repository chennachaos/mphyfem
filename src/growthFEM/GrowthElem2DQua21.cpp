...
GrowthElem2DQua21::GrowthElem2DQua21()
{
...
void GrowthElem2DQua21::prepareElemData()
{
...
double GrowthElem2DQua21::computeVolume(bool init)
{
...
int GrowthElem2DQua21::calcMassMatrix(MatrixXd& Mlocal, bool MassLumping)
{
...
int GrowthElem2DQua21::calcMassMatrixPressure(MatrixXd& Mlocal, bool MassLumping)
{
...
double  GrowthElem2DQua21::calcCriticalTimeStep(bool flag)
{
    int  ii;
...
int GrowthElem2DQua21::calcForceVectorGrowthModel(VectorXd& Flocal1, VectorXd& Flocal2)
{
    ...
    double  Jg  = gp1*gp1;
    MatrixXd  FgInv(3,3), F(3,3), Fn(3,3), Fe(3,3), Fg(3,3);
    F.setZero();
    Fn.setZero();
    Fe.setZero();
    Fg.setZero();
...
int GrowthElem2DQua21::calcStiffnessAndResidualMixed2(MatrixXd& Kup, MatrixXd& Kpu, MatrixXd& Kpp, VectorXd& Flocal1, VectorXd& Flocal2, bool firstIter)
{
...
int GrowthElem2DQua21::calcResidual(VectorXd& Flocal)
{
...
int GrowthElem2DQua21::calcResidualPressure(VectorXd& Flocal)
{
    int gp, ii;
    VectorXd  N(nlbfU), dN_dx(nlbfU), dN_dy(nlbfU);
...
int GrowthElem2DQua21::solveForPressure()
{
    cout << "'GrowthElem2DQua21::solveForPressure()' ... not implemented yet " << endl;
...
int GrowthElem2DQua21::calcLoadVector(VectorXd& Flocal)
{
...
int GrowthElem2DQua21::calcInternalForces()
{
  return 0;
}
...
void GrowthElem2DQua21::elementContourplot(int vartype, int varindex, int index)
{
   double outval[50];
   ...
   switch(vartype)
   {
       ...
       default:
              ...
              cout  << " Invalid Variable Type to project in 'GrowthElem2DQua21::projectToNodes'" << endl;
              break;
    }
...
void GrowthElem2DQua21::projectToNodes(bool extrapolateFlag, int vartype, int varindex, int index)
{
   double outval[50];
...
void GrowthElem2DQua21::projectStress(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
    int   err,  isw,  count,  count1, ll = 0, ii, jj, gp;

    double  detF, dvol, Jac, fact, dvol0, param[2], Np[4];
...
void GrowthElem2DQua21::projectStrain(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
  return;
}
...
void GrowthElem2DQua21::projectInternalVariable(bool extrapolateFlag, int vartype, int varindex, int index, double* outval)
{
...
int  GrowthElem2DQua21::calcError(int index)
{
    // compute error
    ///////////////////////////////////////////////////////////
