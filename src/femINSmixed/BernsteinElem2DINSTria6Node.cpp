...
void BernsteinElem2DINSTria6Node::findLocalCoordinates(vector<myPoint>& node_coords, myPoint& coords_global, myPoint& coords_local)
{
...
void BernsteinElem2DINSTria6Node::prepareElemData(vector<myPoint>& node_coords)
{
    ...
    nodeNumsPres[0] = nodeNums[0];
    nodeNumsPres[1] = nodeNums[1];
    nodeNumsPres[2] = nodeNums[2];
...
double  BernsteinElem2DINSTria6Node::ResidualIncNavStokesAlgo1(vector<myPoint>& node_coods, double* elemData, double* timeData, VectorXd& veloVec, VectorXd& veloVecPrev, VectorXd& veloDotVec, VectorXd& veloDotVecPrev, VectorXd& presVec, VectorXd& presVecPrev, VectorXd&  FlocalVelo, VectorXd&  FlocalPres, double timeCur)
{
    double  b1, b2, b3, b4;
...
int  BernsteinElem2DINSTria6Node::ResidualIncNavStokesAlgo2(vector<myPoint>& node_coords, double* elemData, double* timeData, VectorXd& veloPrev, VectorXd& veloDotPrev, VectorXd& presPrev, VectorXd&  FlocalPres)
{
...
double  BernsteinElem2DINSTria6Node::calcCriticalTimeStep(double* elemData, double* timeData, VectorXd&  veloVec)
{
...
/*
int  BernsteinElem2DINSTria6Node::StiffnessAndResidualFullyImplicit(vector<myPoint>& node_coords, double* elemData, double* timeData, VectorXd& veloPrev, VectorXd& veloPrev2, VectorXd& veloCur, VectorXd& veloDotCur, VectorXd& presCur, MatrixXd& Kuu, MatrixXd& Kup, VectorXd& Fu, VectorXd& Fp, double timeCur)
{
...
int  BernsteinElem2DINSTria6Node::StiffnessForSemiImpl(double* elemData, double* timeData, MatrixXd& Kup)
{
...
int BernsteinElem2DINSTria6Node::MassMatrices(vector<myPoint>& node_coords, double* elemData, VectorXd&  Mlocal1, VectorXd&  Mlocal2)
{
    int  ii;
...
//
double  BernsteinElem2DINSTria6Node::CalculateError(vector<myPoint>& node_coords, double* elemData, double* timeData, VectorXd& veloCur, VectorXd& veloDotPrev, VectorXd& presCur, double timeCur, int index)
{
...
/*
double  BernsteinElem2DINSTria6Node::CalculateError(vector<myPoint>& node_coords, double* elemData, double* timeData, VectorXd& veloPrev, VectorXd& veloDotPrev, VectorXd& presPrev, double timeCur, int index)
{
...
int BernsteinElem2DINSTria6Node::toComputeInfSupCondition(vector<myPoint>& node_coords, double* elemData, MatrixXd& Kuu, MatrixXd& Kup, MatrixXd& Kpp)
{
//
...
int  BernsteinElem2DINSTria6Node::CalculateForces(int side, vector<myPoint>& node_coords, double* elemData, double* timeData, VectorXd& veloVec, VectorXd& presVec, VectorXd&  Flocal1)
{
    // side 0 - 1-4-2
    // side 1 - 2-5-3
    // side 2 - 3-6-1
